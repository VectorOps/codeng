...
TOOL_CALL_STATUS_STYLE = "dim grey50"
...
TOOL_CALL_COMPONENT_STYLE = tui_terminal.ComponentStyle(
    padding_pad=(0, 0, 0, 1),
)

TOOL_CALL_OUTPUT_BLOCK_STYLE = "on rgb(0,80,0)"

TOOL_CALL_PANEL_STYLE = "on rgb(18,18,18)"
TOOL_CALL_PANEL_BORDER_STYLE = "rgb(18,18,18)"
