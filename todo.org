...
** [ ] Create TUI library of special characters
*** [ ] Icons by name, ASCII fallback vs unicode
*** [ ] Automatic detection of correct fonts (how? setting?)
*** [ ] Use icons from library instead of hard-coded values
...
*** [X] Long list display
** [ ] Add collapse/expand
*** [ ] ctrl+e to collapse/expand last 10 messages
*** [ ] ctrl+shift+e to collapse/expand whole history
*** [ ] ctrl+t to collapse/expand last 10 tool call requests/results
*** [ ] per-project collapse default settings: tool, messages, etc.
...
*** [ ] Figure out good naming convention
