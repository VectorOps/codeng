...
* [ ] General
** [ ] Add TUI message plumbing to UIServer
- Figure out a way to send back responses
** [ ] Add state to UIServer - first message sent to idle state should start the workflow
