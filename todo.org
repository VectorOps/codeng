...
** [ ] Fix autocomplete logic for /run - shift+enter should submit instead of accepting auto-complete.
- Don't show auto-complete if option exactly matches
** [X] LLM usage stats
...
** [ ] Gemini 3 support
*** [ ] Store thought signatures for Gemini models
*** [ ] Temperature control
*** [ ] Investigate why we're printing thinking process
*** [ ] Store raw responses (or signatures) along with step state messages. Use stored responses when generating chat history over raw messages.
* [ ] Runner
...
* [ ] System prompts
** [ ] Discovery
*** [ ] Gemini does not really do a good job explaining tool calls
*** [ ] Gemini does not use search
*** [ ] Gemini plan for architect is too long
