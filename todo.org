...
* [ ] General
** [ ] Fix component addition/removal for help
** [ ] Rework tooltip
- Add support for history management (going up when help is visible) 
- If hint text matches input text, enter should work as an enter and not as autocompletion
...
** [ ] Need to rename read_files to read_file9. Animation stops after showing/hiding toolbar component
...
** [ ] Add hidden flag to components to prevent components from being removed from the bottom
** [ ] Combine input + toolbar + help + etc to a single component due to dynamic component shifting17. When inserting component to a specific position, skip deleted items.
