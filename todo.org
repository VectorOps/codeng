...
* [ ] General
** [ ] Support streaming MCP transports
*** [ ] Introduce intermediate tool response support
*** [ ] Figure out how to handle bi-directional communication with MCP
*** [ ] Update runner, tool call manager, etc
...
** [ ] Implement combined input/http_input component
*** [ ] Think about unified input executor
