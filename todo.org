...
*** [ ] Add visual identation for tool calls
*** [ ] Get rid of emojis for statuses, use unicode or ascii symbols
*** [ ] Generic formatter to have line-mode
*** [ ] Better list formatting (comma-separated without parenthesis)
*** [ ] Long list display
